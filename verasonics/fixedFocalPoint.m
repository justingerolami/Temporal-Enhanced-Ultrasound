...
%   for its use
%
% File name: FixedFocalPoint.m - Example of linear array imaging with 
%                                     focused transmits
% Description: 
...
%   acquisition. 
% 
%   This file was designed to capture a set number of frames of Ultrasound
%   time-series (TeUS) data. 
...
P.startDepth = 0;
P.endDepth = 128;
P.txFocus = 41;  % Initial transmit focus.
